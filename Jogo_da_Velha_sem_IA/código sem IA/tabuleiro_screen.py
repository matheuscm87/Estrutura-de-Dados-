...
class TabuleiroScreen:
    ...
    def desenha_botao_reiniciar(self):
        pygame.draw.rect(self.screen, (200, 200, 200), (250, 660, 200, 30))  # botão cinza
        font = pygame.font.SysFont("Arial", 24)
        txt = font.render("Jogar Novamente", True, (0, 0, 0))
        self.screen.blit(txt, (270, 662))
        pygame.display.update()

    def clicou_reiniciar(self, pos):
        return 250 <= pos[0] <= 450 and 660 <= pos[1] <= 690
